<div class="box box-info">
    ...
    <div class="box-body">
        ...
        <?php 
            ...
            {
                $hasil = $ortu->simpan_ortu($_POST['nama_ayah_siswa'],$_POST['tempat_lahir_ayah'],$_POST['tgl_lahir_ayah'],$_POST['agama_ayah'],$_POST['kewarganegaraan_ayah'],$_POST['pendidikan_ayah'],$_POST['penghasilan_perbulan_ayah'],$_POST['alamat_rumah_ayah'],$_POST['no_tlp_ayah'],$_POST['keadaan_ayah'],$_POST['nama_ibu_siswa'],$_POST['tempat_lahir_ibu'],$_POST['tgl_lahir_ibu'],$_POST['agama_ibu'],$_POST['kewarganegaraan_ibu'],$_POST['pendidikan_ibu'],$_POST['pekerjaan_ibu'],$_POST['penghasilan_perbulan_ibu'],$_POST['alamat_rumah_ibu'],$_POST['no_tlp_ibu'],$_POST['keadaan_ibu']);
