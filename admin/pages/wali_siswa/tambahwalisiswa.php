            ...
            <div class="box-body">
                ...
                if (isset($_POST['simpan'])) 
                {
                    ...
                    else
                    {
                        ...
                        echo "<script>location='index.php?halaman=tambahwalisiswa';</script>";
                    }
